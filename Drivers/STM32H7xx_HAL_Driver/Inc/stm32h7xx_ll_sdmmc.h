...
#define SDMMC_CMDTIMEOUT                   ((uint32_t)110U)        		/* i made it microsec Command send and response timeout     */
...
#define SDMMC_STOPTRANSFERTIMEOUT          ((uint32_t)1000U)   			/* Timeout for STOP TRANSMISSION command */
