...
#ifndef INC_FLIGHT_CK_PID_H_
#define INC_FLIGHT_CK_PID_H_
...
#define PID_ARRAY_ROW 		3 // Roll, pitch, yaw
#define PID_ARRAY_COLUMN 	5 //  P   I   D	 F	  Dmax

extern int PID_SELECTED_PROFILE[PID_ARRAY_ROW][PID_ARRAY_COLUMN];
...
typedef enum{
	...
	PID_FF,
	PID_Dmax
}pid_parameter_names_e;

// Betaflight definitions
...
#define PID_ROLL_DEFAULT  { 45, 80, 30, 120, 43 }
#define PID_PITCH_DEFAULT { 47, 84, 34, 125, 49 }
